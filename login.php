            ...
            <div class="row" style="margin-top: 70px;">
                <div class="col-lg-12">
                    <div class="intro-message">
                        ...
                        <form method="post" action="selectgeolocation.php">
                            <table class="table table-bordered table-hover" style="margin:0 auto; margin-top:40px; width:450px;">
                                <tbody>
                                <tr>
                                    <td>Username</td>
                                    <td><input class="form form-control" name="username" type="text"></td>
                                </tr>
                                <tr>
                                    <td>Password</td>
                                    <td><input class="form form-control" name="email" type="email"></td>
                                </tr>
									<td colspan="1">
